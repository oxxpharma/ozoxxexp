...
import { LayoutDashboard, Palette, Users, Ticket, ShoppingCart, Settings2, CalendarRange, LogOut, ChevronLeft } from "lucide-react";
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-ozx-bg flex">
      <aside className="w-64 border-r border-white/5 bg-ozx-bg2/40 backdrop-blur-xl fixed inset-y-0 flex flex-col">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition ${
                  isActive ? "bg-ozx-primary/10 text-ozx-primary border border-ozx-primary/20" : "text-ozx-muted hover:text-white hover:bg-white/5"
                }`
              }
        ...
        <div className="p-4 border-t border-white/5">
          <p className="text-xs text-ozx-muted">{user?.email}</p>
